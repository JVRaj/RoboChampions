...
const int MAX_LEFT = 140;
const int MAX_RIGHT = 40;
const int mb = 14;
const int mf = 27;
...
// ---------- Loop ----------
void loop() {
  int left = readTFLunaUART(tfLunaL, prevLeft);
  int right = readTFLunaUART(tfLunaR, prevRight);
  int front = readFrontTF();
  float headingX = readHeadingX();

  // --- NEW: After finishing 12 turns ---
  if (finishedTurns) {
